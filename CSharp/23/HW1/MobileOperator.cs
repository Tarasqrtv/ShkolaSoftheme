...
namespace HW1
{
    class MobileOperator
    {
		...
		public readonly Logger Log = new Logger();
        ...
        private void MobileAccount_MessageEvent(object sender, SMS smsEventArgs)
        {
            ...
            if (uniqCheckXElement != null)
            {
				...
				Log.Add(new Login(mobileAccountSender, mobileAccountReceiver.Value, _messageRate));
            }
        }
        ...
        private void MobileAccount_CallEvent(object sender, PhoneNumber phoneNumber)
        {
            ...
            if (uniqCheckXElement != null)
            {
				...
				Log.Add(new Login(mobileAccountSender, mobileAccountReceiver.Value, _callRate));
            }   
        }
